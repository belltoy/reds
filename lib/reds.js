...
Query.prototype.end = function(fn){
  ...
  var query = this.str;
  var words = exports.stem(exports.stripStopWords(exports.words(query, this.search.tokenizer)));
...
Search.prototype.index = function(str, id, fn){
  var key = this.key;
  var db = this.client;
  var words = exports.stem(exports.stripStopWords(exports.words(str, this.tokenizer)));
